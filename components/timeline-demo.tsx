  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Launched our revolutionary hosting platform with zero-downtime deployments and global edge network coverage
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="https://images.unsplash.com/photo-1551434678-e076c223a692?w=500&h=500&fit=crop"
              alt="modern hosting dashboard"
              width={500}
              height={500}
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Expanded our infrastructure to support enterprise-level deployments with advanced security features and compliance standards.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Introduced AI-powered optimization tools that automatically scale resources based on traffic patterns and performance metrics.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
            ...
            />
            <Image
              src="https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=500&h=500&fit=crop"
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Released 5 major platform improvements this quarter
          </p>
          <div className="mb-8">
            ...
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Advanced CDN with 200+ edge locations
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
